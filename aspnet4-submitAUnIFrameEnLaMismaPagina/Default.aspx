...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Button ID="btnAceptar" runat="server" Text="Aceptar" PostBackUrl="~/PaginaIframeDestino.aspx"  OnClientClick="enviarDatosAFrame('iframePaginaHija');"/>
    
    <asp:Button ID="btnAceptarConjQuery" runat="server" Text="Aceptar (con jQuery)" PostBackUrl="~/PaginaIframeDestino.aspx"  CssClass="postbackToFrame" data-frameDestino="iframePaginaHija"   />
